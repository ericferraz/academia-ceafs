...
public class InstrutorPO implements Serializable{
	...
	public boolean equals( Object obj ) {
		...
		InstrutorPO other = (InstrutorPO) obj;
		if ( funcionario == null ) {
	...
	public String toString() {
		return "InstrutorPO [" + ( getId() != null ? "getId()=" + getId() + ", " : "" ) + ( getFuncionario() != null ? "getFuncionario()=" + getFuncionario() : "" ) + "]";
	}
